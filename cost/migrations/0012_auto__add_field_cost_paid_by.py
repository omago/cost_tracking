...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cost.paid_by'
        db.add_column('cost', 'paid_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='paid_by', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cost.paid_by'
        db.delete_column('cost', 'paid_by_id')
    ...
    models = {
        ...
        u'cost.cost': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paid_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'paid_by'", 'to': u"orm['auth.User']"}),
