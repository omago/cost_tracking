...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cost.created_by'
        db.add_column('cost', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='created_by', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cost.created_by'
        db.delete_column('cost', 'created_by_id')
