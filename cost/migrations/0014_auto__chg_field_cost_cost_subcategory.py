...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cost.cost_subcategory'
        db.alter_column('cost', 'cost_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cost_subcategory.CostSubcategory'], null=True))

    def backwards(self, orm):

        # Changing field 'Cost.cost_subcategory'
        db.alter_column('cost', 'cost_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cost_subcategory.CostSubcategory']))
