...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cost.deleted'
        db.add_column('cost', 'deleted',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Adding field 'Cost.deleted_by'
        db.add_column('cost', 'deleted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cost.deleted'
        db.delete_column('cost', 'deleted')

        # Deleting field 'Cost.deleted_by'
        db.delete_column('cost', 'deleted_by_id')
    ...
    models = {
        ...
        u'cost.cost': {
            ...
            'deleted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
