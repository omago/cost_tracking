...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cost.deleted'
        db.alter_column('cost', 'deleted', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Cost.deleted_by'
        db.alter_column('cost', 'deleted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Cost.deleted'
        db.alter_column('cost', 'deleted', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Cost.deleted_by'
        db.alter_column('cost', 'deleted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'cost.cost': {
            ...
            'deleted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
