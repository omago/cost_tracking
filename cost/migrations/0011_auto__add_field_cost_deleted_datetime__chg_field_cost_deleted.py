...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cost.deleted_datetime'
        db.add_column('cost', 'deleted_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Cost.deleted'
        db.alter_column('cost', 'deleted', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Cost.deleted_datetime'
        db.delete_column('cost', 'deleted_datetime')
    ...
    models = {
        ...
        u'cost.cost': {
            ...
            'deleted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'deleted_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
