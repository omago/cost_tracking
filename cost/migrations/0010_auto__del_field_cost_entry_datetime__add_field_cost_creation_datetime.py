...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cost.entry_datetime'
        db.delete_column('cost', 'entry_datetime')

        # Adding field 'Cost.creation_datetime'
        db.add_column('cost', 'creation_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cost.entry_datetime'
        db.add_column('cost', 'entry_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Deleting field 'Cost.creation_datetime'
        db.delete_column('cost', 'creation_datetime')
