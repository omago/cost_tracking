...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CostName.deleted'
        db.add_column('cost_name', 'deleted',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CostName.deleted_datetime'
        db.add_column('cost_name', 'deleted_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CostName.deleted_by'
        db.add_column('cost_name', 'deleted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cost_name_deleted_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CostName.deleted'
        db.delete_column('cost_name', 'deleted')

        # Deleting field 'CostName.deleted_datetime'
        db.delete_column('cost_name', 'deleted_datetime')

        # Deleting field 'CostName.deleted_by'
        db.delete_column('cost_name', 'deleted_by_id')
